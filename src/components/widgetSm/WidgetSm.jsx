        ...
        <div>
            ...
            <ul className="widgetSmList">
                <li className="widgetSmListItem">
                    <img src="https://thumbs.dreamstime.com/z/muslim-man-flat-avatar-icon-you-can-use-illustration-business-websites-company-others-140436092.jpg" alt="" className="widgetSmImg" />
                    <div className="widgetSmUser">
                        <span className="widgetSmUsername">Faizz Roslee</span>
                ...
                <li className="widgetSmListItem">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHnv8LCaD8_7urrpxxT9AswgonrU3VqSfIFA&usqp=CAU" alt="" className="widgetSmImg" />
                    <div className="widgetSmUser">
                        <span className="widgetSmUsername">Muaz Ahmad</span>
                ...
                <li className="widgetSmListItem">
                    <img src="https://cdn3.vectorstock.com/i/1000x1000/43/87/muslim-avatar-people-flat-icon-vector-28504387.jpg" alt="" className="widgetSmImg" />
                    <div className="widgetSmUser">
                        <span className="widgetSmUsername">Mohd Amiruddin</span>
                        <span className="widgetSmUserTitle">Back-End Engineer</span>
                    </div>
                    <button className="widgetSmButton">
                        <Visibility className="widgetSmIcon"/> Display
                    </button>
